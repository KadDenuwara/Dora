...
public class GeminiPro {
    ...
    public void getResponseImage(String query, Bitmap image, ResponseCallback callback) {
        GenerativeModelFutures model = getModelImage();
    ...
    public void getResponseText(String query, ResponseCallback callback) {
    ...
    public GenerativeModelFutures getModelImage() {
        String apiKey = BuildConfig.apiKey;
